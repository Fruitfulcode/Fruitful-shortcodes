<?php
	...
	function ffs_register_tinymce_elements( $buttons )  {
		array_push($buttons, 'ffs_tabs', 'ffs_description_box', 'ffs_one_half_column', 'ffs_one_third_column', 'ffs_two_third_column', 'ffs_one_fourth_column', 'ffs_three_fourth_column', 'ffs_one_fifth_column', 'ffs_sep');  
		return $buttons;
	}

	function ffs_add_tinymce_elements( $plugin_array )  {
		$plugin_array['ffs_tabs'] 			   = plugins_url('/tinymce', __FILE__) . '/ffs.tinymce.js';
		$plugin_array['ffs_description_box']   = plugins_url('/tinymce', __FILE__) . '/ffs.tinymce.js';
